...
export const inputBase =
  "bg-surface border border-border rounded-xl px-4 py-[10px] text-[14.5px] text-primary placeholder:text-muted outline-none focus:border-accent/60 focus-visible:ring-2 focus-visible:ring-accent/70 transition-all duration-300";
