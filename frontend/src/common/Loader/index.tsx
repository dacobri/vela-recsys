...
export const SkelatonLoader: FC<SkelatonLoaderProps> = memo(
  ({ className, isMoviesSliderLoader = true }) => {
    ...
    return (
      <SkeletonTheme baseColor="#16131F" highlightColor="#241F33">
...
export const Loader = memo(() => {
  return (
    <div className="relative bg-background top-0 left-0 w-screen h-screen flex justify-center items-center">
