...
const Section: FC<SectionProps> = ({
  ...
  const linkStyle = cn(
    `sm:py-1 py-[2px] sm:text-[14px] xs:text-[12.75px] text-[12px] sm:px-4 px-3 rounded-full text-gray-300 hover:-translate-y-1 hover:text-primary transition-all duration-300 view-all-btn--dark`
  );
