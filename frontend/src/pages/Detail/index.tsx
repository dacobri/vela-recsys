...
const Detail = () => {
  ...
  useEffect(() => {
    document.title =
      (movie?.title || movie?.name) && !isLoading
        ? `${movie.title || movie.name} — Vela`
        : "Vela — your personal map of cinema";
  ...
  const backgroundStyle = {
    backgroundImage: `linear-gradient(to top, rgba(11,10,18,1), rgba(11,10,18,0.98), rgba(11,10,18,0.82), rgba(11,10,18,0.5)), url('${imageUrl(
      posterPath
    )}')`,
