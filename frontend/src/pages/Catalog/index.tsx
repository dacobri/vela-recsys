        ...
        {isFetching && !isCategoryChanged ? (
          ...
          <div className="w-full flex items-center justify-center">
            <button
              ...
              disabled={isFetching}
              className="sm:py-2 xs:py-[6px] py-1 sm:px-5 xs:px-4 px-[12px] bg-accent text-accent-text rounded-full md:text-[15.25px] sm:text-[14.75px] xs:text-[14px] text-[12.75px] shadow-glow hover:-translate-y-1 transition-all duration-300 font-semibold my-4"
            >
              Load more
            </button>
          </div>
